      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
        ...
        <div>
          ...
          <div class="flex flex-col items-start mt-5 space-y-2">
            <a href="./index.php" class="text-black transition-colors duration-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Home</a>
            <a href="./about.php" class="text-black transition-colors duration-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Who We Are</a>
            <a href="./about.php" class="text-black transition-colors duration-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Our Philosophy</a>
          </div>
        </div>

        <div>
          <p class="font-semibold text-gray-800 dark:text-white">Cattegory</p>

          <div class="flex flex-col items-start mt-5 space-y-2">
            <a href="./index.php" class="text-black transition-colors duration-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Home</a>
            <a href="./room.php" class="text-black transition-colors duration-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Rooms</a>
            <a href="./contact.php" class="text-black transition-colors duration-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Contact</a>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center justify-between">
        <a href="#">
          ...
          <div class="text-black md:order-1">
            <h3 class="text-2xl font-bold">SKYward</h3>
          </div>
        </a>
