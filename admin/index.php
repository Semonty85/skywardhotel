    ...
    <aside class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        <div>
            <div class="-mx-6 px-6 py-4">
                <h2 class="font-semibold text-2xl">SkYward</h2>
            </div>

            <ul class="space-y-2 tracking-wide mt-8">
                <li class="pagebtn active">
                    <a href="#" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4">
                ...
                <li class="pagebtn">
                    <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                        ...
                        <span class="group-hover:text-gray-700">Booking</span>
                    </a>
                </li>
                <li class="pagebtn">
                    <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                ...
                <li class="pagebtn">
                    <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                        ...
                        <span class="group-hover:text-gray-700">Staf</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
            <button class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                ...
                <a href="logout.php"><span class="group-hover:text-gray-700">Logout</span></a>
            </button>
        </div>
    </aside>
